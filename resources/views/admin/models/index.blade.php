                    ...
                    <tbody>
                        @forelse($models as $model)
                            @php
                                ...
                                $isAvailable = (bool)($model['is_available'] ?? false);
                            @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $typeBadgeClass }} {{ $type === 'Preview' ? 'text-dark' : '' }}">
                                        {{ $type }}
                                    </span>
                                </td>
                                ...
                                <td>
                                    ...
                                    @else
                                        <div class="small">
                                            ${{ number_format((float)($model['input_price_per_1m'] ?? 0), 2) }} input
                                        </div>
                                        <div class="small text-muted">
                                            ${{ number_format((float)($model['output_price_per_1m'] ?? 0), 2) }} output
                                        </div>
                                    @endif
                                </td>

                                <td>
                                    <div class="small">{{ number_format((int)($model['context_window'] ?? 0)) }} tokens</div>
                                    <div class="small text-muted">
                                        Max completion: {{ number_format((int)($model['max_completion'] ?? 0)) }}
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    @else
                                        <span class="badge bg-secondary">Catalog only</span>
                                    @endif
                                </td>
                            </tr>
                        @empty
